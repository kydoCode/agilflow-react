...
export default function Modal({ modalOpen, setIsModalOpen, editingStory, onSave, isEditing }) {
    ...
    const selectClass = "mt-1 block w-full rounded-md border border-gray-300 pl-3 pr-8 py-2 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50";
