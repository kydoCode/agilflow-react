    ...
    <Header />
      ...
      <div className="container mx-auto px-4 pt-16 pb-32 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          {/* 3D Dashboard Display - Désactivé temporairement (cause bande blanche 768px/1296px)
          <div className="hidden md:block relative perspective-[2000px]">
        ...
        <div className="relative">
          <div className="bg-[#0B1E3D] rounded-2xl shadow-2xl p-4 transform rotate-0 md:rotate-3 hover:rotate-0 transition-transform duration-500">
